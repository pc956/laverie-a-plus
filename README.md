...
| Carte interactive | v25b (v24 + couche Sprint A + correctif géoloc) | `1_carte/carte_prospection_etape3a_v25b_paris_92_corrigee.html` |
...
```
1_carte/                      → carte v25b (DERNIÈRE VERSION, géoloc corrigée — à utiliser)
