...
HTML_OUT = '/home/claude/workspace/outputs/carte_prospection_etape3a_v23_revenu.html'
GEOJSON  = '/home/claude/workspace/iris/iris_92_enriched_v2.geojson'
  ...
  <div id="iris-panel-card">
    ...
    <div id="iris-panel-body">
      ...
      <div class="iris-var-grid">
        <div class="iris-var-btn active" data-var="DISP_MED21" onclick="IrisLayer.setVar(this)">💶 Revenu médian</div>
        ...
        <div class="iris-var-btn" data-var="P22_RP" onclick="IrisLayer.setVar(this)" style="grid-column:span 2;">🏘️ Ménages</div>
      </div>
      ...
      <div id="iris-source">Source : INSEE recens. 2022 + Filosofi 2021 (616 IRIS)</div>
    </div>
  </div>
</div>
  ...
  function buildPopup(props) {
    ...
    return `
      ...
      <table class="iris-popup-table">
        ...
        <tr><td colspan="2" style="padding-top:6px;border-top:1px solid #eee;font-size:10px;color:#999;">Revenus disponibles 2021 (€/UC)</td></tr>
        <tr><td><b>Médiane</b></td><td>${props.DISP_MED21 != null ? '<b>' + Math.round(props.DISP_MED21).toLocaleString('fr-FR') + ' €</b>' : '—'}</td></tr>
        <tr><td>1<sup>er</sup> quartile (Q1)</td><td>${props.DISP_Q121 != null ? Math.round(props.DISP_Q121).toLocaleString('fr-FR') + ' €' : '—'}</td></tr>
        <tr><td>3<sup>e</sup> quartile (Q3)</td><td>${props.DISP_Q321 != null ? Math.round(props.DISP_Q321).toLocaleString('fr-FR') + ' €' : '—'}</td></tr>
        <tr><td>Taux pauvreté (60 %)</td><td>${props.DISP_TP6021 != null ? props.DISP_TP6021.toFixed(1) + ' %' : '—'}</td></tr>
      </table>
    `;
  }
